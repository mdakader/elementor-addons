        ...
        $this->add_control(
            'team_style', [
                ...
                'options' => [
                    ...
                    'team-style-4' => esc_html__('Team Style 4', 'eassy-addons'),
                    'team-style-5' => esc_html__('Team Style 5', 'eassy-addons'),
                    'team-style-6' => esc_html__('Team Style 6', 'eassy-addons'),
                    'team-style-7' => esc_html__('Team Style 7', 'eassy-addons'),
                    'team-style-8' => esc_html__('Team Style 8', 'eassy-addons'),
                    'team-style-9' => esc_html__('Team Style 9', 'eassy-addons'),
                    ...
                    'team-style-13' => esc_html__('Team Style 13', 'eassy-addons'),
                    'team-style-14' => esc_html__('Team Style 14', 'eassy-addons'),
                    'team-style-15' => esc_html__('Team Style 15', 'eassy-addons'),
                    'team-style-16' => esc_html__('Team Style 16', 'eassy-addons'),
                    'team-style-17' => esc_html__('Team Style 17', 'eassy-addons'),
                    'team-style-18' => esc_html__('Team Style 18', 'eassy-addons'),
