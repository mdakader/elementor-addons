...
class Banner_Widget extends Widget_Base {
    ...
    public function get_name() {
        return 'easy_banner_widget';
    }


    public function get_title() {
        return __('Banner', 'easy-addons');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'easy_banner_style', [
                ...
                'options' => [
                    'easy-banner-style-1' => esc_html__('Banner Style 1', 'easy-addons'),
                    'easy-banner-style-2' => esc_html__('Banner Style 2', 'easy-addons'),
                    'easy-banner-style-3' => esc_html__('Banner Style 3', 'easy-addons'),
                ],
                'default' => 'easy-banner-style-1',
            ]
        );
        ...
        if ($blog_posts->have_posts()) :
            ...
            <div class="post_card grid-container post-card-grid-gap elementor-grid <?php echo $card_style . ' ' . $column; ?>" >
                ...
                while ($blog_posts->have_posts()) : $blog_posts->the_post();
                    ...
                    switch ($settings['easy_banner_style']) {
                        case 'easy-banner-style-1':
                            include EASY_ADDONS_PATH . '/widgets/banner/banners/banner-style-1.php';
                            break;
                        case 'easy-banner-style-2':
                            include EASY_ADDONS_PATH . '/widgets/banner/banners/banner-style-2.php';
                            break;
                        case 'easy-banner-style-3':
                            include EASY_ADDONS_PATH . '/widgets/banner/banners/banner-style-3.php';
                            break;
                        default:
                            include EASY_ADDONS_PATH . '/widgets/banner/banners/banner-style-1.php';
                            break;
